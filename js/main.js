...
function create() {
    ...
    button2 = game.add.button(32, 448, 'button', actionOnClick1, this, 2, 1, 0);

    button2.onInputOver.add(over, this);
    button2.onInputOut.add(out, this);
    button2.onInputUp.add(up, this);
    
    button3 = game.add.button(32, 496, 'button', actionOnClick1, this, 2, 1, 0);

    button3.onInputOver.add(over, this);
    button3.onInputOut.add(out, this);
    button3.onInputUp.add(up, this);
    
    button4 = game.add.button(32, 540, 'button', actionOnClick1, this, 2, 1, 0);
